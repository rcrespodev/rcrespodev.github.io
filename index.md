...
- Design, construction and support using ABAP language:
    ...
    - Z module for the tax information management and tax calculations on sales operations (ABAP, Hana, SQL).
...
_Inside project_. Design and implementation the solution for the RG 4919/2021 - "Factura de Crédito MyPyme" (ABAP, Hana, SQL).
...
- Design and development of Z accounting module (ABAP, Hana, SQL):
...
- Design and development of complex queries for obtain Financial Statements and Cash Flow reports (ABAP, Hana, SQL).
